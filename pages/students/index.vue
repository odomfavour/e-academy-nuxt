  ...
  <div>
      <div class="container-fluid">
                  ...
                  <b-card class="h-100 marked">
                      <div class="row no-gutters w-100">
                        ...
                        <div class="col-6 align-self-end text-right">
                            <img src="/student.png" alt="Customer Support" class="img-fluid illustration-img">
                        </div>
                    </div>
                  </b-card>
              </b-col>
          ...
          <b-row>
              <b-col></b-col>
              <b-col md="3"> 
                  <b-button variant="primary" block class="mb-3" v-b-modal.calendar>View Calendar</b-button>
              </b-col>
            ...
            <b-row>
              <b-col>
                <div class="learning-path">
                  ...
                  <b-card no-body class="py-2 px-3 mb-2" v-for="(card, index) in 4" :key="index">
                    <b-row>
                        <b-col md="2">
                          <b-img v-bind="{ blank: true, blankColor: '#777', width: 40, height: 40, class: 'm1' }" rounded alt="Rounded image"></b-img>
                        </b-col>
                        <b-col md="10">
                ...
                <b-col md="6">
                  <b-card>
                    <div class="top">
                      <b-row>
                        <b-col md="3">
                          <b-img v-bind="{ blank: true, blankColor: '#777', width: 60, height: 40, class: 'm1' }" rounded alt="Rounded image"></b-img>
                        </b-col>
                        <b-col md="9">
                          <div class="d-flex justify-content-between">
                            <div class="">
            ...
            <b-card>
                ...
                <b-table striped hover :items="users" outlined responsive>
                    <template #cell(view)="data">
                        <nuxt-link class="btn btn-outline-info" :to="`/projects/${data.index}`">View</nuxt-link>
                    </template>
                </b-table>
            </b-card>
...
export default {
    ...
    data() {
        return {
            projects: [
                 {name: "Mathematic's classwork", start_date: '01/01/2018', end_date: "01/01/2018", status: 'Done', Teacher: 'Mr. Calculua', view: ""},
                 {name: "Mathematic's classwork", start_date: '01/01/2018', end_date: "01/01/2018", status: 'Done', Teacher: 'Mr. Calculua', view: ""},
                 {name: "Mathematic's classwork", start_date: '01/01/2018', end_date: "01/01/2018", status: 'Done', Teacher: 'Mr. Calculua', view: ""},
                 {name: "Mathematic's classwork", start_date: '01/01/2018', end_date: "01/01/2018", status: 'Done', Teacher: 'Mr. Calculua', view: ""},
                 {name: "Mathematic's classwork", start_date: '01/01/2018', end_date: "01/01/2018", status: 'Done', Teacher: 'Mr. Calculua', view: ""},
